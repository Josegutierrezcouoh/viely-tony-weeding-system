...
export default async function InvitationPage({ params }: PageProps) {
  ...
  if (error || !invitation) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-white to-rose-50 flex items-center justify-center">
        <div className="text-center p-12 bg-white rounded-lg shadow-xl border border-rose-100 max-w-md">
          <svg className="w-16 h-16 text-rose-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <h1 className="text-3xl font-serif text-rose-900 mb-4">Invitación no encontrada</h1>
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-rose-50">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-xl border-2 border-rose-200 inline-block">
            <p className="text-2xl md:text-3xl font-serif text-rose-900 mb-2">
              Estimado/a
            </p>
