...
export default function InvitationContent({ invitation }: InvitationContentProps) {
    ...
    <div className="min-h-screen bg-linear-to-b from-white to-purple-50">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <div className="mb-8">
            <div className="inline-block">
              <svg className="w-16 h-16 md:w-24 md:h-24 text-purple-600 mx-auto mb-4" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
              </svg>
            </div>
          </div>
          <h1 className="text-5xl md:text-7xl font-serif text-purple-900 mb-6 leading-tight">
            Viely & Tony
          </h1>
          <div className="w-24 h-1 bg-purple-600 mx-auto mb-6"></div>
          <p className="text-xl md:text-2xl text-purple-800 mb-4 font-light tracking-wide">
            Nos casamos
          </p>
          <p className="text-3xl md:text-4xl font-serif text-purple-900 mb-8">
            02 de Enero, 2026
          </p>
          <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-xl border-2 border-purple-200 inline-block">
            <p className="text-2xl md:text-3xl font-serif text-purple-900 mb-2">
              Estimado/a
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-serif text-purple-900 text-center mb-12">
            Ceremonia de Boda
          </h2>

          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-linear-to-br from-purple-50 to-white p-8 rounded-lg shadow-lg border border-purple-100">
              <div className="flex items-center mb-4">
                <svg className="w-8 h-8 text-purple-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <h3 className="text-2xl font-serif text-purple-900">Fecha y Hora</h3>
              </div>
            ...
            <div className="bg-linear-to-br from-purple-50 to-white p-8 rounded-lg shadow-lg border border-purple-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-serif text-purple-900">Lugar</h3>
              </div>
          ...
          <div className="mb-12 text-center">
            <h3 className="text-3xl font-serif text-purple-900 mb-6">Los Novios</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-8 rounded-lg shadow-md border border-purple-100">
              <h4 className="text-2xl font-serif text-purple-900 mb-4 text-center">Padres del Novio</h4>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md border border-purple-100">
              <h4 className="text-2xl font-serif text-purple-900 mb-4 text-center">Padres de la Novia</h4>
              <div className="space-y-2 text-center text-gray-700">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-8 rounded-lg shadow-md border border-purple-100">
              <h4 className="text-2xl font-serif text-purple-900 mb-4 text-center">Padrinos del Novio</h4>
              <div className="space-y-2 text-center text-gray-700">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md border border-purple-100">
              <h4 className="text-2xl font-serif text-purple-900 mb-4 text-center">Padrinos de la Novia</h4>
              <div className="space-y-2 text-center text-gray-700">
          ...
          {/* Damas de Honor */}
          <div className="mb-12">
            <h3 className="text-3xl font-serif text-purple-900 text-center mb-8">Damas de Honor</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <div key={index} className="p-4 bg-purple-50 rounded-lg text-center border border-purple-100">
          ...
          <div className="text-center mb-8">
            <h3 className="text-3xl font-serif text-purple-900 mb-6">Pajes</h3>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mt-6">
            <a
              ...
              className="inline-block bg-purple-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-purple-700 transition-colors shadow-lg"
            >
              Ver en Google Maps
            </a>
          </div>
      ...
      {/* RSVP */}
      <section className="py-16 bg-linear-to-b from-purple-50 to-white">
        <div className="max-w-6xl mx-auto px-4">
          {!hasResponded ? (
            <RSVPForm
      ...
      <footer className="bg-purple-900 text-white py-12">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <div className="mb-6">
            <svg className="w-12 h-12 text-purple-200 mx-auto mb-4" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
            </svg>
          </div>
          <p className="text-2xl font-serif mb-2">Viely & Tony</p>
          <p className="text-purple-200">02 de Enero, 2026</p>
